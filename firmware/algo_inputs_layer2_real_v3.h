#ifndef ALGO_INPUTS_LAYER2_REAL_V3_H
#define ALGO_INPUTS_LAYER2_REAL_V3_H
...
void algo_inputs_layer2_real_v3(hls::stream<axi_t> link_in[3*NTRACK+3*NCALO],hls::stream<axi_t> allparts_in [4*NCALO+4*NTRACK]);
